...
window.onload = function () {
    ...
    // get handle for video placeholder
    pwm_id = document.getElementById('pwm-bar');
    pwm_turn_id = document.getElementById('pwm-turn-bar');
    setPwm(pwm_id,pwm_turn_id);
